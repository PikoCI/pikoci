...
- Documentation: added "Build Logs & Security" section to Pipeline Reference documenting that command lines are never shown in build logs, added job block summary table, added missing sub-block fields to all config tables, fixed mkdocs nav (removed phantom Queue.md, added Pause and Resource Pinning pages) ([#502](https://github.com/PikoCI/pikoci/issues/502))
