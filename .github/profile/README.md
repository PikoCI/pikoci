<div align="center">
  ...
  **The portable CI/CD. One binary, any database, runs anywhere.**
...
PikoCI is a self-hosted CI/CD system inspired by [Concourse CI](https://concourse-ci.org), built around a resource/resource-type pipeline model. It runs as a single binary with a pluggable database backend — start in memory for development, add SQLite for persistence, scale to PostgreSQL with distributed workers.
...
- **Pluggable everything** — databases (SQLite, MySQL, PostgreSQL), runners, secret backends
